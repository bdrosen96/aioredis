...
class StringCommandsMixin:
    ...
    def bitpos(self, key, bit, start=None, end=None):
        ...
        return self._execute(b'BITPOS', key, bit, *bytes_range)
    ...
    def decrby(self, key, decrement):
        ...
        return self._execute(b'DECRBY', key, decrement)

    def get(self, key, *, encoding=_NOTSET):
        """Get the value of a key."""
        return self._execute(b'GET', key, encoding=encoding)
    ...
    def getbit(self, key, offset):
        ...
        return self._execute(b'GETBIT', key, offset)
    ...
    def getrange(self, key, start, end):
        ...
        return self._execute(b'GETRANGE', key, start, end)
    ...
    def incrby(self, key, increment):
        ...
        return self._execute(b'INCRBY', key, increment)
    ...
    def incrbyfloat(self, key, increment):
        ...
        if not isinstance(increment, float):
            raise TypeError("increment must be of type int")
        fut = self._execute(b'INCRBYFLOAT', key, increment)
        return wait_convert(fut, float)

    def mget(self, key, *keys):
        """Get the values of all the given keys."""
        return self._execute(b'MGET', key, *keys)
    ...
    def mset(self, key, value, *pairs):
        ...
        fut = self._execute(b'MSET', key, value, *pairs)
        return wait_ok(fut)
    ...
    def msetnx(self, key, value, *pairs):
        ...
        if len(pairs) % 2 != 0:
            raise TypeError("length of pairs must be even number")
        return self._execute(b'MSETNX', key, value, *pairs)
    ...
    def psetex(self, key, milliseconds, value):
        ...
        fut = self._execute(b'PSETEX', key, milliseconds, value)
        return wait_ok(fut)
    ...
    def set(self, key, value, *, expire=0, pexpire=0, exist=None):
        ...
        if exist is self.SET_IF_EXIST:
            ...
            args.append(b'NX')
        fut = self._execute(b'SET', key, value, *args)
        return wait_ok(fut)
    ...
    def setbit(self, key, offset, value):
        ...
        return self._execute(b'SETBIT', key, offset, value)
    ...
    def setex(self, key, seconds, value):
        ...
        if not isinstance(seconds, int):
            raise TypeError("milliseconds argument must be int")
        fut = self._execute(b'SETEX', key, seconds, value)
        return wait_ok(fut)

    def setnx(self, key, value):
        """Set the value of a key, only if the key does not exist."""
        fut = self._execute(b'SETNX', key, value)
    ...
    def setrange(self, key, offset, value):
        ...
        if offset < 0:
            raise ValueError("offset must be greater equal 0")
        return self._execute(b'SETRANGE', key, offset, value)
