...
class SetCommandsMixin:
    ...
    def sadd(self, key, member, *members):
        ...
        return self._execute(b'SADD', key, member, *members)
    ...
    def sdiff(self, key, *keys):
        ...
        return self._execute(b'SDIFF', key, *keys)

    def sdiffstore(self, destkey, key, *keys):
        """Subtract multiple sets and store the resulting set in a key."""
        return self._execute(b'SDIFFSTORE', destkey, key, *keys)

    def sinter(self, key, *keys):
        """Intersect multiple sets."""
        return self._execute(b'SINTER', key, *keys)

    def sinterstore(self, destkey, key, *keys):
        """Intersect multiple sets and store the resulting set in a key."""
        return self._execute(b'SINTERSTORE', destkey, key, *keys)

    def sismember(self, key, member):
        """Determine if a given value is a member of a set."""
        return self._execute(b'SISMEMBER', key, member)
    ...
    def smove(self, sourcekey, destkey, member):
        ...
        return self._execute(b'SMOVE', sourcekey, destkey, member)

    def spop(self, key):
        """Remove and return a random member from a set."""
        return self._execute(b'SPOP', key)

    def srandmember(self, key, count=None):
        """Get one or multiple random members from a set."""
        args = [key]
        count is not None and args.append(count)
        return self._execute(b'SRANDMEMBER', *args)

    def srem(self, key, member, *members):
        """Remove one or more members from a set."""
        return self._execute(b'SREM', key, member, *members)

    def sunion(self, key, *keys):
        """Add multiple sets."""
        return self._execute(b'SUNION', key, *keys)

    def sunionstore(self, destkey, key, *keys):
        """Add multiple sets and store the resulting set in a key."""
        return self._execute(b'SUNIONSTORE', destkey, key, *keys)
    ...
    def sscan(self, key, cursor=0, match=None, count=None):
        ...
        fut = self._execute(b'SSCAN', *tokens)
