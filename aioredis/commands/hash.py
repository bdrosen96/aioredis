...
class HashCommandsMixin:
    ...
    def hdel(self, key, field, *fields):
        ...
        return self._execute(b'HDEL', key, field, *fields)

    def hexists(self, key, field):
        """Determine if hash field exists."""
        fut = self._execute(b'HEXISTS', key, field)
        return wait_convert(fut, bool)

    def hget(self, key, field, *, encoding=_NOTSET):
        """Get the value of a hash field."""
        return self._execute(b'HGET', key, field, encoding=encoding)

    # TODO: add encoding param
    def hgetall(self, key):
        """Get all the fields and values in a hash."""
        fut = self._execute(b'HGETALL', key)
    ...
    def hincrbyfloat(self, key, field, increment=1.0):
        ...
        fut = self._execute(b'HINCRBYFLOAT', key, field, increment)
    ...
    def hmget(self, key, field, *fields):
        ...
        return self._execute(b'HMGET', key, field, *fields)

    def hmset(self, key, field, value, *pairs):
        """Set multiple hash fields to multiple values."""
        return self._execute(b'HMSET', key, field, value, *pairs)
    ...
    def hscan(self, key, cursor=0, match=None, count=None):
        ...
        fut = self._execute(b'HSCAN', *args)
